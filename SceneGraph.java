...
public class SceneGraph extends JPanel {
    ...
    private void createWorld() {
        ...
        rotatingPolygon1.setScale(0.01,0.01).setColor(Color.ORANGE);
        rotatingPolygon1.setTranslation(-3,2);
        world.add(rotatingPolygon1);
        
        rotatingPolygon1a = new TransformedObject(filledPolygon);
        rotatingPolygon1a.setScale(0.01,0.01).setColor(Color.ORANGE);
        ...
        triangle3.setScale(0.4,0.8).setColor(Color.DARK_GRAY);
